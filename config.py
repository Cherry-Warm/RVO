...
def config():
    ...
    parser.add_argument('--net_path', type=str, default='./weight')
    parser.add_argument('--writer_comment', type=str, default='CFP')
    parser.add_argument('--save_net', type=bool, default=True)
